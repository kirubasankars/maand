...
def test_start_jobs():
    ...
    agents = workspace.get_agent_ip_by_role("group3")
    ...
    agents = workspace.get_agent_ip_by_role("group2")
    for agent_ip in agents:
    ...
    agents = workspace.get_agent_ip_by_role("group1")
    for agent_ip in agents:
